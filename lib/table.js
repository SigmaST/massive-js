...
Table.prototype.save = function(obj, fields, next){
  var args;
  if(!_.isObject(obj)){
    args = {};
    args[this.primaryKeyName()] = obj;
    args = _.extend(fields, args);
  }else{
    args = obj;
  }
  this._save(args,next);
};
Table.prototype.saveSync = DA(Table.prototype.save);

Table.prototype._save = function(args, next){
...
Table.prototype._saveSync = DA(Table.prototype._save);
